...
function SubmitButton() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="w-full bg-primary-container text-on-primary text-xs font-bold uppercase tracking-widest py-3.5 rounded hover:bg-secondary-container hover:shadow-[0_0_20px_rgba(57,184,253,0.3)] transition-all duration-150 flex justify-center items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
...
export default function Contact() {
  ...
  return (
    <section
      id="contacto"
      className="bento-card col-span-1 md:col-span-4 bg-surface-container-lowest rounded-lg p-6 md:p-8 flex flex-col justify-between"
    >
      <div>
        <h2
        ...
        >
          Abierto a proyectos interesantes, colaboraciones y consultas.
        </p>
      </div>
